...
/* package reverse-interpreter-0.1.0.0 */
#define VERSION_reverse_interpreter "0.1.0.0"
#define MIN_VERSION_reverse_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "reverse-interpreter-0.1.0.0"

#define CURRENT_PACKAGE_KEY "reverse-interpreter-0.1.0.0"
